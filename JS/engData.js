const engQuizData = [
    ...
    { id: 3, name: "School", vdoId: "KNxtkBUlcXY", questions: [{ q: "What is this? 📖", a: ["Book", "Pen"], correct: 0, hint: "หนังสือ" }, { q: "What is this? 🖊️", a: ["Pen", "Bag"], correct: 0, hint: "ปากกา" }, { q: "Where do you study?", a: ["School", "Hospital"], correct: 0, hint: "โรงเรียน" }, { q: "Who teaches you?", a: ["Teacher", "Doctor"], correct: 0, hint: "คุณครู" }, { q: "What is this? 🎒", a: ["Bag", "Desk"], correct: 0, hint: "กระเป๋า" }] },
    { id: 4, name: "Food & Drink", vdoId: "RAOSqD9bkSM", questions: [{ q: "Do you like pizza? 🍕", a: ["Yes, I do.", "No, it is a dog."], correct: 0, hint: "ชอบไหม" }, { q: "What is this? 🍎", a: ["Apple", "Banana"], correct: 0, hint: "สีแดงๆ" }, { q: "What is this? 🥛", a: ["Milk", "Water"], correct: 0, hint: "นม" }, { q: "Is this a banana or orange? 🍌", a: ["Banana", "Orange"], correct: 0, hint: "สีเหลืองๆ" }, { q: "What is this? 🍚", a: ["Rice", "Bread"], correct: 0, hint: "ข้าว" }] },
    { id: 5, name: "Everyday English", vdoid: "fzCKfgBJXMk", questions: [{ q: "What color is this? 🔴", a: ["Red", "Blue"], correct: 0, hint: "สีแดง" }, { q: "What color is the sky? ☁️", a: ["Blue", "Green"], correct: 0, hint: "สีฟ้า" }, { q: "What is this? 🚗", a: ["Car", "Train"], correct: 0, hint: "รถยนต์" }, { q: "What is this? 🐶", a: ["Dog", "Cat"], correct: 0, hint: "สุนัข" }, { q: "How many fingers on one hand? 🖐️", a: ["Five (5)", "Ten (10)"], correct: 0, hint: "มือข้างเดียวมีกี่นิ้ว" }] },
    { id: 6, name: "Time", vdoid: "ZuWWu-gidY8", questions: [{ q: "What time is it? (7:00)", a: ["Seven o'clock", "Ten o'clock"], correct: 0, hint: "เลข 7" }, { q: "Morning or night? ☀️", a: ["Morning (เช้า)", "Night (กลางคืน)"], correct: 0, hint: "พระอาทิตย์ขึ้น" }, { q: "Morning or night? 🌙", a: ["Night (กลางคืน)", "Morning (เช้า)"], correct: 0, hint: "พระจันทร์ขึ้น" }, { q: "When do you sleep?", a: ["At night", "In the morning"], correct: 0, hint: "เวลานอน" }, { q: "When do you eat lunch?", a: ["Noon / Afternoon", "Night"], correct: 0, hint: "กินข้าวเที่ยง" }] },
    { id: 7, name: "My Free Time", vdoid: "", questions: [{ q: "Do you play games? 🎮", a: ["Yes, I play games.", "I eat rice."], correct: 0, hint: "ถามว่าเล่นเกมไหม" }, { q: "Do you watch TV? 📺", a: ["Yes, I do.", "I sleep."], correct: 0, hint: "ดูทีวี" }, { q: "Do you play football? ⚽", a: ["Yes / No", "I am a bird."], correct: 0, hint: "ฟุตบอล" }, { q: "Do you listen to music? 🎵", a: ["Yes", "Cat"], correct: 0, hint: "ฟังเพลง" }, { q: "Do you read books? 📚", a: ["Yes", "Dog"], correct: 0, hint: "อ่านหนังสือ" }] },
    { id: 8, name: "Fill in the blank", vdoid: "p7AfQeVmukM", questions: [{ q: "I ___ a boy.", a: ["am", "is"], correct: 0, hint: "I ใช้กับอะไร" }, { q: "She ___ my mom.", a: ["is", "are"], correct: 0, hint: "She ใช้กับอะไร" }, { q: "This is a ___ 🐶", a: ["dog", "cat"], correct: 0, hint: "สุนัข" }, { q: "We ___ friends.", a: ["are", "is"], correct: 0, hint: "We แปลว่าพวกเรา (หลายคน)" }, { q: "I ___ happy. 😄", a: ["am", "are"], correct: 0, hint: "I ใช้กับอะไร" }] },
    { id: 9, name: "ทายบุคคลดัง (Basic)", vdoid: "", questions: [{ q: "Who is he? (มนุษย์แมงมุม 🕷️)", a: ["Spider-Man", "Batman"], correct: 0, hint: "พ่นใยได้" }, { q: "Who is he? (คนเหล็ก 🤖🔴)", a: ["Iron Man", "Superman"], correct: 0, hint: "ใส่ชุดเกราะสีแดง" }, { q: "Who is she? (เจ้าหญิงน้ำแข็ง ❄️)", a: ["Elsa", "Anna"], correct: 0, hint: "Let it go~" }, { q: "Who is he? (นักเตะหมายเลข 10 อาร์เจนติน่า ⚽)", a: ["Messi", "Ronaldo"], correct: 0, hint: "แชมป์โลก" }, { q: "Who is he? (พ่อมดน้อยมีแผลเป็น ⚡)", a: ["Harry Potter", "Mr. Bean"], correct: 0, hint: "ขี่ไม้กวาด" }] },
    {
